...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/aldwinakbar/Dropbox/Projects/campus/team/TRUI/amvui2015/AI/src/pid)
  set(pid_DEVEL_PREFIX /home/aldwinakbar/Dropbox/Projects/campus/team/TRUI/amvui2015/AI/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/aldwinakbar/Dropbox/Projects/campus/team/TRUI/amvui2015/AI/install)
...
if(NOT "/home/aldwinakbar/Dropbox/Projects/campus/team/TRUI/amvui2015/AI/devel/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/aldwinakbar/Dropbox/Projects/campus/team/TRUI/amvui2015/AI/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aldwinakbar/Dropbox/Projects/campus/team/TRUI/amvui2015/AI/src/pid/${idir}'.  Ask the maintainer 'Andy Zelenak <andyz@utexas.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/aldwinakbar/Dropbox/Projects/campus/team/TRUI/amvui2015/AI/devel/lib;/home/aldwinakbar/Dropbox/Projects/campus/team/TRUI/amvui2015/AI/devel/lib;/home/aldwinakbar/Dropbox/Projects/campus/team/voice-controlled-drone/hardware/ros/devel/lib;/opt/ros/indigo/lib)
...
set(pid_EXPORTED_TARGETS "pid_generate_messages_cpp;pid_generate_messages_lisp;pid_generate_messages_py")
